...
.table-curved tr.green td:first-child:before {
  background-color: forestgreen;
    ...
    <div class="panel panel-default">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="true" AllowPaging="True" AllowSorting="True" CssClass="table table-curved table-hover table-striped text-codemess table-dark " BackColor="Gray" BorderColor="#33CCFF" ForeColor="white" OnRowDeleting="GridView1_RowDeleting" GridLines="Horizontal" AutoGenerateColumns="False">
            <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Button ID="Button1" CommandName="Delete" runat="server" Text="Ištrinti(CRASH)" CssClass="btn btn-danger"/>
                </ItemTemplate>
            </asp:TemplateField>
                ...
                <asp:BoundField DataField="CoachId" HeaderText="Trenerio ID" />
        </Columns>
        </asp:GridView>
        </div>
        <div>
