<%@ Page Title="Varžybų redagavimas" Language="C#" AutoEventWireup="true" Culture="lt-LT" UICulture="lt-LT" MasterPageFile="~/Site.Master" CodeBehind="CreateCompetition.aspx.cs" Inherits="WebApplication.Admin.CreateCompetition" %>
    ...
    <h2><%: Title %>.</h2>
        ...
        <div>
            ...
            <ul class="nav nav-tabs navTabFormat">
              <li class="nav-item"><a class="nav-link active" id="home-tab1" data-toggle="tab" onclick="openCity(event, 'creation')" id="defaultOpen">Sukurti varžybas</a></li>
